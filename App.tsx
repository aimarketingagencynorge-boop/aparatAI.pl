...
const App: React.FC = () => {
  const [currentStep, setCurrentStep] = useState<AppState>(AppState.MISSION_HUB);
      ...
      const response = await ai.models.generateContent({
        ...
        contents: {
          parts: [
            ...
            { text: `Professional studio photography. High-end lighting, satin anthracite flow background. 8k hyper-detailed product.` }
          ]
        },
    ...
    <div className="relative min-h-screen w-full text-white selection:bg-blue-600/30">
          ...
          <div className="w-full h-full rounded-full border-4 border-blue-500/20 bg-black/40 backdrop-blur-3xl flex flex-col items-center justify-center p-8 overflow-hidden shadow-[0_0_80px_rgba(37,99,235,0.2)] glitch-effect">
            ...
            {isProcessing ? (
              ...
              <div className="z-10 w-full h-full">
                ...
                <div className="absolute bottom-10 left-1/2 -translate-x-1/2 mono text-[8px] text-blue-500/60 uppercase tracking-[0.4em] font-bold text-center pointer-events-none">
      ...
      <div className="relative z-10 bg-black/20">
        <section ref={manualRef} className="py-32 px-10 flex flex-col items-center">
          <h2 className="text-5xl md:text-7xl font-black italic uppercase tracking-tighter mb-20 text-center leading-tight">
             INSTRUKCJA <br/> <span className="text-blue-600">DOWODZENIA</span>
          </h2>
        ...
        <section ref={faqRef} className="py-32 px-10 pb-64 flex flex-col items-center">
          <div className="max-w-4xl w-full">
            <h2 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter mb-20 text-center">SYSTEM <span className="text-blue-600">INTEL (FAQ)</span></h2>
          ...
          <>
            ...
            >
              ...
              <div className="mb-10 flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-3xl md:text-4xl font-black italic uppercase text-blue-500 leading-none mb-2">
      ...
      <div className="fixed bottom-0 left-0 w-full z-[150]">
        ...
        <div className="flex justify-center py-6 px-10 gap-16 bg-black/60 backdrop-blur-3xl border-t border-white/5">
          <button onClick={() => scrollTo(homeRef)} className="flex flex-col items-center gap-1 group">
             <span className="text-2xl group-hover:scale-125 transition-transform duration-300">🏠</span>
             <span className="mono text-[8px] uppercase tracking-widest text-white/40 group-hover:text-blue-500 font-bold">DOM</span>
          </button>
      ...
      {/* Global Result Display (Modal-like section) */}
      <AnimatePresence>
          ...
          >
             <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div className="space-y-10">
                   <h2 className="text-7xl font-black italic uppercase leading-none tracking-tighter">RENDER <br/><span className="text-blue-600">UKOŃCZONY.</span></h2>
                   <p className="text-white/50 text-2xl italic leading-relaxed">System zsyntezował dane RAW do formatu 8K Master. Oświetlenie studyjne i cienie zostały nałożone poprawnie.</p>
                   <div className="flex flex-col gap-6">
                      {credits === 0 ? (
                        <button className="px-12 py-8 bg-red-600/20 border border-red-500 text-red-500 font-black italic rounded-full uppercase tracking-widest text-sm cursor-not-allowed">
                          PAYWALL: KUP PRO DLA KOLEJNEGO RENDERU
                        </button>
                      ) : (
                      ...
                      <button onClick={() => window.open(result.url)} className="px-12 py-6 border border-white/20 rounded-full text-white font-black italic uppercase tracking-widest hover:bg-white/5">POBIERZ PLIK 8K</button>
                ...
                <div className="aspect-square rounded-[60px] overflow-hidden border-2 border-blue-500/30 shadow-[0_0_80px_rgba(37,99,235,0.2)]">
